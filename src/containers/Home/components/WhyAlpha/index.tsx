        ...
        <Fade bottom>
          <div className="why_alpha_fees_text">
            ...
            <p>
              ...
              payment requests, are absolutely free of charge.We only charge fees for funding your wallet or checking
              out your wallet, anything else such as transfers, payment requests, are absolutely free of charge.
            </p>
          </div>
        </Fade>
      </div>
      ...
      <div className="why_alpha_security">
        <Fade bottom>
          <div className="why_alpha_security_text">
            ...
            <p>
              We verify our users before activating their accounts. Every transaction carried out on our platform and
              also users personal details is kept private and highly confidential. Data is securely transferred to and
              from the website via SSL and we encrypt all personal information collected using the highest encryption
              standard
            </p>
          </div>
        </Fade>
